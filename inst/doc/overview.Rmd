...
The figure doesn't look better than the defaults, but the point of the function create a theme suitable for publication (black and white, high resolution, with large text).
